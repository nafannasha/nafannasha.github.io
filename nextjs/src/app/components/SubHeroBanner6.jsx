...
const SubHeroBanner6 = ({
  ...
  return (
    <>
      {/* DESKTOP BANNER */}
      <div
        className="bg-cover bg-center bg-no-repeat h-[31.25rem] hidden md:block"
        style={{
      ...
      {/* SMALL MOBILE BANNER */}
      <div
        className={"xs:hidden h-[35rem] bg-cover bg-center bg-no-repeat -mt-10"}
        style={{
          backgroundImage: `url(${mobileSmallImage})`,
        }}
      >
        <div className="max-w-[1440px] mx-auto">
          <FullWidthSection>
